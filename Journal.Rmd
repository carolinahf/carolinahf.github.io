...
*Answer*: I want to replicate analysis so that's why its nice to rename data
...
This is my answer to this questionn. Use this command to make the state names into a new variable called State. 
